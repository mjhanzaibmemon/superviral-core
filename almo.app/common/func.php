...
function track_activity($account_id, $activity, $activity_desc)
{
    $added = time();


    $query = "INSERT INTO account_stats (`account_id`, `activity_type`, `description`, `added`) VALUES ('$account_id', '$activity', '$activity_desc', '$added')";
