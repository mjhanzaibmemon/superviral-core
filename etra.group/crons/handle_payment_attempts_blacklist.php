...
$QueryRun = mysql_query("SELECT *
                        ...
                        WHERE `type` = 'payment_attempts_per_hour'");
...
while($dataQueryRun = mysql_fetch_array($QueryRun)){
    ...
    if($count > 30 && $sendSms == 0){
        ...
        //TEXT ME
            ...
            $Message->body = $msg.' EXCESS card payment attempts: '.$dataQueryRun['metric'].'. ReCaptcha is on.';
       ...
       $UpdateQueryRun = mysql_query("UPDATE admin_statistics 
        ...
        echo 'Reset Metric Successfully for Superviral <br><br>';
