...
$q = mysql_query("SELECT * FROM `automatic_likes` WHERE `disabled` = '0' AND `expires` > $now AND `last_updated` NOT BETWEEN '$threehoursago' AND '$now' ORDER BY `id` ASC LIMIT 50");
