...
$order1 = $api->order(array('service' => $packageinfo['jap1'], 'link' => 'https://instagram.com/'.$fetchorder['igusername'], 'quantity' => $packageinfo['amount']));
...
if(($updateq)&&(!empty($fulfillid))){header('Location: '.$defectpagefrom.'orders.php?type='.$pagefrom.'&message=updatetrue2&theid='.$orderid123.$noorderstate);}
