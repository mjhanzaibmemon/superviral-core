...
if(!empty($orderid) && empty($undoRefund)){
...
if(!empty($alorderid) && empty($undoRefund)){
		...
		if($updateq)$success = '<div class="emailsuccess">A refund of £'.$customamount.' has been issued to Subscription #'.$alorderid.$refundreason.'</div>';
...
<script src="ckeditor/ckeditor.js"></script>
	...
	<body>
		...
		<h1 style="text-align:center;margin-top:35px;">Finalise Refunds 💳</h1>

		<div class="box23">

		<a href="?page=0" class="btn btn3 report copy-button nlbtn">⏪ First Refund</a>
    			<a href="?page=<?=($page - 1)?>" class="btn btn3 report copy-buttonn nlbtn">◀️ Previous Refund</a>
    			<a href="?page=<?=($page + 1)?>" class="btn btn3 report copy-button nlbtn">Next Refund ▶️</a>
				<span style="float: right;padding-top: 10px;"><?=$totalleft?></span>
