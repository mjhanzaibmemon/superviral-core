...
function addInput(divName){
     if (counter == limit)  {
          ...
          newdiv.innerHTML = "" + (counter + 1) + ". <br><input autocomplete=\"off\" name=\"myInputs[]\" value=\"\" style=\"margin-bottom:15px;\" class=\"input\" placeholder=\"https://www.instagram.com/p/CEG6R7_FGdD/\">";
	...
	<body>
		...
		<h1 style="text-align:center;margin-top:35px;"><?=$id?>: Free Likes</h1>
		...
		<div class="box23">
			...
			<table class="articles">
				...
				<tr>
					...
					<td>Amount</td>
					<td><input autocomplete="off" name="amount" placeholder="0" class="input"><br>minimum amount: 100 per IG post</td>
