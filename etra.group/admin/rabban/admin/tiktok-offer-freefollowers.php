...
if((!empty($orderid))&&(!empty($username))&&(!empty($amount))){
			...
			$order1 = $api->order(array('service' => $freefollowersorderid, 'link' => 'https://www.tiktok.com/@'.$username, 'quantity' => $amount));
...
<script src="ckeditor/ckeditor.js"></script>
	...
	<body>
		...
		<h1 style="text-align:center;margin-top:35px;"><?=$svgtiktokh1?> <?=$id?>: Free Followers</h1>
		...
		<div class="box23">
			...
			<table class="articles">
				...
				<tr>
					...
					<td></td>
					<td><input style="float:left;width:190px;" onclick="return confirm('Are you sure you want to offer these free TikTok followers?');" type="submit" name="submit" class="btn color3" value="Give Free Followers"></td>
