...
var my=window.open("ckeditor/plugins/custimage/dialogs/dialog.php?id=" +  auniqueid,"ImageBrowser","menubar=0,resizable=0,width=500,height=300");//change this code to your desired page
