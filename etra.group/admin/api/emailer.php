...
require $_SERVER['DOCUMENT_ROOT'].'/admin/common/phpmailer/src/Exception.php';
require $_SERVER['DOCUMENT_ROOT'].'/admin/common/phpmailer/src/PHPMailer.php';
require $_SERVER['DOCUMENT_ROOT'].'/admin/common/phpmailer/src/SMTP.php';
