...
<div style="width: 90%;margin:auto"> 
    ...
    <div>
        ...
        <h1>Receipt of Order: #'. $orderID .'</h1>
    ...
    <div>
        ...
        <table style="border: 1px solid black;width:100%">
            ...
            <tbody >
                ...
                <tr ><td>Service</td><td>'. $orderAmount .' '. $packageType .'</td></tr>
    ...
    <br>
        ...
        <h5>151 Lodge Road, West Bromwich, West Midlands, B70 8PJ, United Kingdom</h5>
