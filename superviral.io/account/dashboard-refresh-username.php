			...
			<div class="cnwidth">
				...
				<div class="container tycontainer dshadow">
					...
					<div class="competitorholder">
							...
							<li><img src="/imgs/ig-icon-input.svg" />@therock<a class="deletethis" href="#"><label class="switch">
  <input type="checkbox" checked>
  <span class="slider round"></span>
</label></a></li>
							<li><img src="/imgs/ig-icon-input.svg" />@cristiano<a class="deletethis" href="#"><label class="switch">
  <input type="checkbox">
  <span class="slider round"></span>
</label></a></li>
							</ul>
					...
					<a href="?closeandrefreshcompetitors=true" class="nothankyou">Close</a>
