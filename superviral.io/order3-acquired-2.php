 ...
 */
 ...
 // get stats
 $statsQuery =  mysql_query("SELECT * FROM `admin_statistics` WHERE `type` = 'payment_attempts_per_hour' LIMIT 1");   
 ...
 $submitBtn = ' <input id="submitbtnthis" type="submit" class="color4 btn" name="submitbtn" onclick="onSubmitData(event);" value="{maincta}">';
 $allowRecaptcha = true;
}else{
...
$body = file_get_contents('order3-acquired-2.html');
