...
$heading = '<span class="firsth1" style="    display: block;
    ...
    text-align: left;">Get 30 Free</span>
			<span class="firsth1" style="font-size: 25px;">Instagram Followers</span>';
...
$cta = '		<div class="cta">
    ...
    font-size: 15px;" placeholder="Enter your email address">
				...
				<input class="btn color3" type="submit" name="submit" value="Get Free Instagram Followers" style="margin: 10px 0 35px 0!important;">
...
$cta = '<div style="margin-top:30px;"><a style="display:block;margin-bottom:10px;text-decoration:underline;color: #193054;" href="https://superviral.co.uk/offerfreetrial.php">Re-enter email address</a><a style="text-align:center;color:black;text-decoration:underline;font-size:14px;color: #193054;" href="/offerfreetrial.php?freetrialo=true">Close window</a></div>


<div class="logo" style="    position: absolute;
    bottom: 21px;"><a title="Superviral" href="#" style="position:relative;float:none">
...
<link rel="stylesheet" type="text/css" href="https://superviral.co.uk/css/buystyle.min.css">
<link rel="stylesheet" type="text/css" href="https://superviral.co.uk/css/orderform.css">
<style type="text/css">
